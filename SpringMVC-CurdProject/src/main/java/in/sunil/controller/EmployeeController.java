...
public class EmployeeController {
	...
	public String deleteEmployee(@RequestParam Integer empId,RedirectAttributes redirct) {
		service.deleteEmployee(empId);
		String message="Employee "+empId+" deleted";
		redirct.addFlashAttribute("message", message);
	...
	@GetMapping("/update")
	public String  updateData(@RequestParam Integer empId,Model model) {
	...
	@PostMapping("/modify")	
	public String upadte(@ModelAttribute Employee emp,RedirectAttributes redirct) {
